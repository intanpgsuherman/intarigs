...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="/AdminLTE/dist/img/profil1.jpg" alt="User Image" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/AdminLTE/dist/img/FT.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <li class="nav-item active">
            <a class="dropdown-item {{request() -> is('MyInformation') ?'active' : ''}}" href="{{route('MyInformation')}}"
           class="m-0 text-lime">MyInformation</a>
        </div>
      </div>
